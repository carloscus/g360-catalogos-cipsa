const CATALOGS_CONFIG = {
  ...
  industriales: { name: 'INDUSTRIALES', theme: 'industriales', gradient: 'linear-gradient(135deg, #2d200a 0%, #0d1117 50%, #1a1505 100%)', accent: '#F39C12', accentGlow: 'rgba(243, 156, 18, 0.4)', total_pages: 32, images_dir: 'images/industriales' },
  representadas: { name: 'REPRESENTADAS', theme: 'representadas', gradient: 'linear-gradient(135deg, #0a1a2d 0%, #0d1117 50%, #05101a 100%)', accent: '#3498DB', accentGlow: 'rgba(52, 152, 219, 0.4)', total_pages: 15, images_dir: 'images/representadas' },
  institucional: { name: 'INSTITUCIONAL', theme: 'institucional', gradient: 'linear-gradient(135deg, #1a1505 0%, #0d1117 50%, #0a0a00 100%)', accent: '#D4AC0D', accentGlow: 'rgba(212, 172, 13, 0.4)', total_pages: 10, images_dir: 'images/institucional' }
};
